                                ...
                                <article class="first-post mb-30 wow fadeIn animated hover-up">
                                    ...
                                    <div class="entry-content">
                                        ...
                                        <h2 class="post-title mb-20">
                                            <a href="#">Barcelona: marathan; south korean pulls away for a grueling surprise</a></h2>
                                        ...
                                        <div class="mb-20 entry-meta meta-2">
                                            ...
                                            <a href="#" class="btn btn-sm">Read more<i class="fi-rs-arrow-right ml-10"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                                ...
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="#">Politic</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="#">The litigants on the screen are not actors</a></h3>
                                        ...
                                        <div class="entry-meta meta-1 font-xs color-grey mt-10 pb-10">
                                            ...
                                            <a href="#" class="text-brand">Read more <i class="fi-rs-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </article>
                            </div>
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="#">Global</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="#">Essential Qualities of Highly Successful Music</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="#">Sport</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="#">9 Things I Love About Shaving My Head</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="#">Technology</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="#">Why Teamwork Really Makes The Dream Work</a></h3>
                            ...
                            <div class="col-lg-6">
                                <article class="wow fadeIn animated hover-up mb-30">
                                    <div class="post-thumb img-hover-scale">
                                        ...
                                        <div class="entry-meta">
                                            <a class="entry-meta meta-2" href="#">Watch</a>
                                        </div>
                                    </div>
                                    <div class="entry-content-2">
                                        <h3 class="post-title mb-15">
                                            <a href="#">The World Caters to Average People</a></h3>
