            ...
            <div class="col-md-6">
                ...
                <form method="post">
                    @if($user->type != 2)
                        ...
                        <div class="form-group">
                            <input type="text" required="" name="lastname" value="{{$user->lastname}}" placeholder="Last name *">
                        </div>
                        <div class="form-group">
                            <input type="text" name="billing_address" value="{{$user->address}}" required="" placeholder="Address *">
                        </div>
                        <div class="form-group">
                            <input required="" type="text" name="phone" value="{{$user->phone}}" placeholder="Phone *">
                        </div>
                        <div class="form-group">
                            <input required="" type="text" name="email" value="{{$user->email}}" placeholder="Email address *">
                        </div>
                    @else
                        <div class="form-group">
                    ...
                    <div class="table-responsive order_table text-center">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th>Price</th>
                                    <td class="product-subtotal" colspan="2">${{number_format($total, 2)}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td colspan="2" class="product-subtotal"><span class="font-xl text-brand fw-900">${{number_format($total * (1-$coupon->discount), 2)}}</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
