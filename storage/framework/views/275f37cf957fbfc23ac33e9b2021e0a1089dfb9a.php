        ...
        <section class="section-padding">
            <div class="container pt-25">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <img src="<?php echo e(asset('assets/imgs/page/about-1.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </section>                
            ...
            <div class="container pt-25">
                ...
                <div class="row align-items-center">
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            <div class="hero-card-icon icon-left-2 hover-up ">
                                <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="<?php echo e(asset('assets/imgs/page/avatar-1.jpg')); ?>" alt="">
                            </div>
                            <div class="pl-30">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            <div class="hero-card-icon icon-left-2 hover-up ">
                                <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="<?php echo e(asset('assets/imgs/page/avatar-3.jpg')); ?>" alt="">
                            </div>
                            <div class="pl-30">
                                <h5 class="mb-5 fw-500">
                                    B.Gates
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            <div class="hero-card-icon icon-left-2 hover-up ">
                                <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="<?php echo e(asset('assets/imgs/page/avatar-2.jpg')); ?>" alt="">
                            </div>
                            <div class="pl-30">
                                <h5 class="mb-5 fw-500">
                                    B. Meyers
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            <div class="hero-card-icon icon-left-2 hover-up ">
                                <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="<?php echo e(asset('assets/imgs/page/avatar-4.jpg')); ?>" alt="">
                            </div>
                            <div class="pl-30">
                                <h5 class="mb-5 fw-500">
                                    J. Bezos
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hero-card box-shadow-outer-6 wow fadeIn animated mb-30 hover-up d-flex">
                            <div class="hero-card-icon icon-left-2 hover-up ">
                                <img class="btn-shadow-brand hover-up border-radius-5 bg-brand-muted" src="<?php echo e(asset('assets/imgs/page/avatar-5.jpg')); ?>" alt="">
                            </div>
                            <div class="pl-30">
                                <h5 class="mb-5 fw-500">
                                    B.Gates
                ...
                <div class="carausel-6-columns-cover position-relative wow fadeIn animated">
                    <div class="carausel-6-columns text-center" id="carausel-6-columns-3">
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-1.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-2.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-3.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-4.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-5.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-6.png')); ?>" alt="">
                        </div>
                        <div class="brand-logo">
                            <img class="img-grey-hover" src="<?php echo e(asset('assets/imgs/banner/brand-3.png')); ?>" alt="">
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kaneki/20221/Lập trình Web/FashionApp/resources/views/about.blade.php ENDPATH**/ ?>