                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="<?php echo e(route('shop')); ?> "><i class="surfsidemedia-font-dress"></i>Women's Clothing</a>
                                    ...
                                    <li class="has-children">
                                        <a href=" <?php echo e(route('shop')); ?> "><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block">
                            <nav>
                                <ul>
                                    ...
                                    <?php if(auth()->guard()->check()): ?>                           
                                        <li><a href="<?php echo e(route('users.show')); ?>">My Account</a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </nav>
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-menu-wrap mobile-header-border">
                    <div class="main-categori-wrap mobile-header-border">
                        ...
                        <div class="categori-dropdown-wrap categori-dropdown-active-small">
                            <ul>
                                <li><a href="<?php echo e(route('shop')); ?>"><i class="surfsidemedia-font-dress"></i>Women's Clothing</a></li>
                                <li><a href="<?php echo e(route('shop')); ?>"><i class="surfsidemedia-font-tshirt"></i>Men's Clothing</a></li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="<?php echo e(route('home')); ?>">Home</a></li>
                            <li class="menu-item-has-children"><span class="menu-expand"></span><a href="<?php echo e(route('shop')); ?>">shop</a></li>
                ...
                <div class="mobile-header-info-wrap mobile-header-border">
                    <div class="single-mobile-header-info mt-30">
                        <a href="<?php echo e(route('contact')); ?>"> Our location </a>
                    </div>
