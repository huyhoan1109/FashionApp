...
} elseif ($_instance->childHasBeenRendered('l32566909-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l32566909-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l32566909-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l32566909-1');
} else {
    $response = \Livewire\Livewire::mount('category-component');
    $html = $response->html();
    $_instance->logRenderedChild('l32566909-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                <?php
...
} elseif ($_instance->childHasBeenRendered('l32566909-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l32566909-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l32566909-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l32566909-2');
} else {
    $response = \Livewire\Livewire::mount('filter-component');
    $html = $response->html();
    $_instance->logRenderedChild('l32566909-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
</section><?php /**PATH /home/kaneki/20221/Lập trình Web/FashionApp/resources/views/livewire/wishlist-component.blade.php ENDPATH**/ ?>